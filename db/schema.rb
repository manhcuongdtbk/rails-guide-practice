...
ActiveRecord::Schema.define(version: 2020_03_21_150923) do
  ...
  create_table "books_categories", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
